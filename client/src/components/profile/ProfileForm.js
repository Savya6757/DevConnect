...
import { createProfile, getUserProfile } from "../../actions/profileActions";
  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={formSubmitHandler}>
        ...
        <div className="my-2">
          <button onClick={showSocialMediaHandler} type="button" className="btn btn-light">
